...
const MoreDetail = () => {
  return (
    <section className="bg-[#F9F9F9] p-5 md:p-16 mt-20">
      <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-5 md:gap-16">
        ...
        <div className="lg:w-1/2 space-y-4">
          ...
          <div>
            ...
            <p className="text-gray text-sm leading-7 mb-5 border-l-4 border-orange-600 pl-5">
              ...
              <br />
              <span className="text-xl font-semibold text-blueDark inline-block mt-2">
                CEO SmartFix
              </span>
            </p>
          </div>
